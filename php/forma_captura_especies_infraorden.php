	...
	****************-->
	<?php
		...
		$query = "SELECT DISTINCT 
				...
				AND especies.\"Suborden\" = '$suborden';";
		...
		while ($data = pg_fetch_object($qu)) 
		{
			if ($data->Infraorden!="" & $data->Infraorden!="NULL")
			{

				if($data->Infraorden!='No Disponible'){  
					echo "<option value = '".$data->Infraorden."'>".$data->Infraorden."</option>"; 
				}
			}	
		}	
		echo "</select>"; 
