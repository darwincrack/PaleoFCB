...
*********************************************************************-->
	...
	****************-->
	<?php
		...
		while($row = pg_fetch_array($result, NULL, PGSQL_ASSOC))
		{
					echo "<option value = '".$row['id_ambiente_depositacion']."'>".$row['Ambiente_Depositacion']." ( ".$row['ida']." ) </option>"; 
		}
	...
	****************-->
	...
	<?php
		...
		while($row = pg_fetch_array($result, NULL, PGSQL_ASSOC))
		{
					echo "<option value = '".$row['id_facies']."'>".$row['facies']." ( ".$row['idf']." ) </option>"; 
		}
	...
	****************-->
	...
	<?php
		...
		// nombre que se imprime en html
		$nombre_combo_box = '<b>7.</b> Contaminaci&oacute;n:';
		// define la variable
